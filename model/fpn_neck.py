...
class FPN(nn.Module):
    ...
    def forward(self,x):
        ...
        C3, C4, C5,C3_Small = x
        # C3_Small,C4,C5=x #added

        P5 = self.prj_5(C5)
        P4 = self.prj_4(C4)
        P3 = self.prj_3(C3)

        P3_Small = self.prj_3(C3_Small) #added
        ...
        P3_Small = P3_Small + self.upsamplelike([P4,C3_Small]) #added

        P3_Small = self.conv_3(P3_Small)
        # P3 = self.conv_3(P3)
        P4 = self.conv_4(P4)
        P5 = self.conv_5(P5)
        ...
        # return [P3_Small, P4, P5, P6, P7]
        # return [P3,P4,P5,P6,P7]
        return [P3,P4,P5,P6,P7,P3_Small]
